...
class ResultFieldForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if division:
            ...
            self.fields['student_class'].queryset = ClassesModel.objects.filter(type=division, result_type='score').order_by('name')
...
class ResultFieldEditForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if division:
            ...
            self.fields['student_class'].queryset = ClassesModel.objects.filter(result_type='score').order_by('name')
        for field in self.fields:
            if field != 'student_class' and field != 'class_section' and field != 'mid_term':
                self.fields[field].widget.attrs.update({
                    'class': 'form-control',
...
class TextResultCategoryForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if division:
            ...
            self.fields['class_section'].queryset = ClassSectionModel.objects.all().order_by('name')
            self.fields['student_class'].queryset = ClassesModel.objects.filter(result_type='text').order_by('name')
        for field in self.fields:
            if field != 'student_class' and field != 'class_section':
                self.fields[field].widget.attrs.update({
                    'class': 'form-control',
