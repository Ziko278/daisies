...
class FeePaymentSelectStudentView(SuccessMessageMixin, TemplateView):
...
class FeePaymentCreateView(SuccessMessageMixin, CreateView):
...
def fee_payment_list_view(request):
    ...
    fee_payment_list = FeePaymentSummaryModel.objects.filter(session=session, term=term)
    context = {
